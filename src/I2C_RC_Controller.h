...
#define MAKERLABVN_I2C_DRIVER_SLAVE_ADDRESS_MIN (70)
...
#define MAX_I2C_MOTOR_RC_SIZE (7)
...
#define I2C_RC_Controller_CREATE_RC_CLASS(index)    void S##index(uint16_t _pulse_us_);\
                                                      void SetS##index(uint16_t _pulseMin_0_Degree, uint16_t _pulseMax_180_Degree);\
                                                      void writeS##index(uint16_t _degree_);\
                                                      void freeS##index();
...
class I2C_RC_Controller
{
public:
  I2C_RC_Controller(uint8_t _address_ = MAKERLABVN_I2C_DRIVER_SLAVE_ADDRESS_MIN);
  void begin();
  ...
  // void freeS1();
  // void freeS2();
  I2C_RC_Controller_CREATE_RC_CLASS(1)
  I2C_RC_Controller_CREATE_RC_CLASS(2)
  I2C_RC_Controller_CREATE_RC_CLASS(3)
  I2C_RC_Controller_CREATE_RC_CLASS(4)
  I2C_RC_Controller_CREATE_RC_CLASS(5)
  I2C_RC_Controller_CREATE_RC_CLASS(6)
  I2C_RC_Controller_CREATE_RC_CLASS(7)
...
private:
  ...
  Str_RC_info infoS1, infoS2, infoSx[MAX_I2C_MOTOR_RC_SIZE];
  ...
  void motorI2C_init()
  {
    ...
    for(int cf = 0; cf < MAX_I2C_MOTOR_RC_SIZE; cf++){
      motorRC[cf].addressId = addressDriver;
      motorRC[cf].modeId = RC_ID;
      motorRC[cf].index = cf+1;
      infoSx[cf].pulseMax = MAKERLABVN_I2C_DRIVER_PULSE_TIME_MAX;
      infoSx[cf].pulseMin = MAKERLABVN_I2C_DRIVER_PULSE_TIME_MIN;
    }
  }
};
#endif